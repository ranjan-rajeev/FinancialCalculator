...
public class SIPCalculatorActivity extends BaseActivity implements View.OnClickListener {
    ...
    class AsyncCalculateEMiDetails extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            bindDeposits();
            yearEmiAdapter = new FDYearAdapter(SIPCalculatorActivity.this, fdDetailsEntityList);
