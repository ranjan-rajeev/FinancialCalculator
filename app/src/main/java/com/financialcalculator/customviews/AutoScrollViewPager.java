...
public class AutoScrollViewPager extends ViewPager {
    ...
    private boolean viewCanStopOnTouch = false;

    public boolean isViewCanStopOnTouch() {
        return viewCanStopOnTouch;
    }

    public void setViewCanStopOnTouch(boolean viewCanStopOnTouch) {
        this.viewCanStopOnTouch = viewCanStopOnTouch;
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        if (isViewCanStopOnTouch() && action == MotionEvent.ACTION_DOWN || action == MotionEvent.ACTION_MOVE) {
            isUserTouching = true;
            stopAutoScroll();
